# Product Strategy Interview Script

**Goal**: Define a rigorous strategy using Rumelt's Kernel (Diagnosis, Guiding Policy, Coherent Actions).
...
"Who are we competing against for this opportunity? What are they doing differently?"
**STOP**: Wait for response.
...
"Finally, what are the Coherent Actions? What specific steps/roadmap items will implement this policy in the next 6 months?"
**STOP**: Wait for response.

---

**Completion**
"I have the strategy components. I will now synthesize this into the Strategy Document."
